...
const newsData: NewsItem[] = [
  {
    id: 1,
    title: 'Российские физики создали сверхпроводник нового поколения',
    date: '2026-08-21',
    image: '/images/example.jpg',
    shortDescription: 'Учёные из МГУ разработали материал, сохраняющий сверхпроводимость при рекордно высокой температуре...',
    fullDescription: 'Это пример новости. Когда ты пришлёшь настоящую базу новостей, этот текст будет заменён на реальный.',
    source: 'ТАСС',
    category: 'russia',
  },
  {
    id: 2,
    title: 'Нобелевская премия 2026 по физике вручена за квантовые технологии',
    date: '2026-08-20',
    image: '/images/example.jpg',
    shortDescription: 'Премия присуждена за прорывные исследования в области квантовых вычислений...',
    fullDescription: 'Пример мировой новости. Полный текст появится, когда ты добавишь базу.',
    source: 'Nature',
    category: 'world',
  },
  {
    id: 3,
    title: 'Фестиваль науки пройдёт в Москве',
    date: '2026-08-15',
    image: '/images/example.jpg',
    shortDescription: 'Крупнейший научно-популярный фестиваль откроется в сентябре. Вас ждут лекции, опыты и экскурсии...',
    fullDescription: 'Пример события с привязкой к региону. В карточке и в полной новости отображается город и регион.',
    source: 'МГУ',
    category: 'events',
    city: 'Москва',
    region: 'г. Москва',
  ...
  {
    id: 4,
    title: 'Объявлены даты Всероссийской олимпиады по физике',
    date: '2026-08-10',
    image: '/images/example.jpg',
    shortDescription: 'Региональный этап ВсОШ по физике пройдёт в январе. Школьники 7-11 классов могут готовиться уже сейчас...',
    fullDescription: 'Пример новости об олимпиадах.',
    source: 'Минобрнауки',
    category: 'olympiads',
  },
]
